export default function MobileApp() {
  return (
    <div className="bg-purple-700 flex justify-between items-center bg-mobile-app rounded-lg text-white">
      <div className="flex flex-col gap-y-3 p-10">
          <h3 className="text-2xl font-bold tracking-tight">Getir'i indirin!</h3>
          <p className="font-semibold">Istediğiniz ürünleri dakikalar içinde <br/>getirelim.</p>
